...
<html lang="en">
    ...
    <body>
        ...
        <div class="content">
            ...
            <div>
            <h3>샘마루(SAMMaru)</h3>
            <div>  <img src="../img/software/sammaru.jpg"  alt="club"></div>
              <div class="promotion">
                동아리소개
                ...
                그리고 체육대회, MT등을 통해 동아리 원들과의 친목을 다지고 타 동아리와의 교류 또한 활성화하고 있습니다.
                <br>
                <input type="button" class="join" value="가입하기"></input>
              </div>
              <div id="map" style="width:150px; height: 150px">
            ...
            <div>
            <h3>CUVIC(SAMMaru)</h3>
            <div>  <img src="../img/software/2020_cuvic.png"  alt="club"></div>
              <div class="promotion">
            ...
            <div>
            <h3>PDA-pro</h3>
            <div>  <img src="../img/software/2020_club_pda.png"  alt="club"></div>
              <div class="promotion">
            ...
            <div>
            <h3>EMSYS</h3>
            <div>  <img src="../img/software/2017_club_emsys.jpg"  alt="club"></div>
              <div class="promotion">
            ...
            <div>
            <h3>Nest.net</h3>
            <div>  <img src="../img/software/2020_nest.png"  alt="club"></div>
              <div class="promotion">
  ...
  매달 체계적인 멘토링과 세미나 를 진행하여 프로그래밍에 대해 자발적인 참여를 유도하고 프로그래밍 외의 발표능력과 같은 부가적인 교육도 진행하고 있습니다. 학교생활을 더욱 즐기고 비상할 수 있는 디딤돌같은 동아리입니다                <br>
                <input type="button" class="join" value="가입하기"></input>
              </div>
            </div><hr>
            <div>
            <h3>CGAC</h3>
            <div>  <img src="../img/software/cgac.jpg"  alt="club"></div>
              <div class="promotion">
        ...
        <script>
            ...
            function myMap() {
                ...
                var myCenter = new google.maps.LatLng(36.623742, 127.457029);
