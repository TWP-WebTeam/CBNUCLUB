    ...
    <body>
        <div class="header">
            ...
            <div class="menu-bar">
                <ul class="main-menu">
                    <li class="sub-menu">
                        <a href="./clubpage_status.html" style="text-decoration: none; color: black;">
                            동아리 현황</a>
                        <ul class="sub-menu2">
                            <li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub-menu2">
                            ...
                            <li>
                                <a href="./apply.html" class="sub-list">신청하기</a>
                            </li>
                            <li>
        ...
        <section id="article" style="height: 200px;">
            <div class="form" style="height: 200px;">
                <form class="form-horizontal" action="../php/home.php" method="POST">
                    <h4 class="bold title" style="padding-left: 35px;">📌동아리 탈퇴신청하기</h4>
                    <div class="form-group">
                      <label class="control-label col-sm-4">동아리명 :</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="cname" name="clubname" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-4">신청자 명 :</label>
                      <div class="col-sm-8">
                        <input type="text" id="name" class="form-control" name="author" required>
                      </div>
                    </div>
                    <div class="form-group">
                        <label for="">탈퇴사유 :</label><br>
                        <div class="col-sm-8">
                            <textarea name="" id="why" cols="35" rows="10" style="resize: none;" placeholder="최소 10자 이상 적어주세요." required></textarea><br>
                        </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10"><br>
                        <input type="submit" name="" id="" value="탈퇴하기"
