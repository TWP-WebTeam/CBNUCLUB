...
var count = 0;
var club = new Array('','북새','소리그리메', 'Alive', '독우회',
 '메디아몬드', '메아꿀빠','보득솔', '스매싱', '아스컴','육현'
 ,'심(心)봉사', '가나연', '따봉','씨밀레', '장구벌레','팝콘','훈울', 'NB','땅볼');
...
function Change_img(num){
    ...
    if(img1.getAttribute('src') == "../img/medicine/img"+num+".jpg" || img1.getAttribute('src') == "../img/noimg.jpg"){
    ...
    if(img2 == 1){
      ...
      img1.setAttribute("src", "../img/medicine/img"+num+".jpg");
      content2.innerHTML = "Click하면 동아리 소개를 볼 수 있어요!";
      content2.style.width = "270px";
      img1.setAttribute("width", "270");
      img1.setAttribute("height", "150");
